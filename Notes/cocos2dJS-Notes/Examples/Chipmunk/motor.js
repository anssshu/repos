...
var myLayer = cc.Layer.extend({
    ...
    init:function () {
       ...
       //--------------------------------------------------------------------//
        ...
        var icon=new DynamicSphere(res.Icon_png,120,200,30,space,"icon");
        this.addChild(icon);

        var  heart=new DynamicRect(res.life_png,100,100,32,32,space,"heart");
        this.addChild(heart)
        ...
        //create a pin joint
        space.addConstraint(new cp.PivotJoint(heart.body,space.staticBody,v(0,0),
         v(100,100)));
        //create a motor
        space.addConstraint(new cp.SimpleMotor(heart.body, space.staticBody, Math.PI*4));
